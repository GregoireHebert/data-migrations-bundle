...
class DataMigrationsExtensionTest extends TestCase
{
    ...
    public function testLoadDefaultConfig()
    {
        ...
        $this->assertEquals('version', $this->container->getParameter('data_migrations.column_name'));
        $this->assertEquals(14, $this->container->getParameter('data_migrations.column_length'));
        $this->assertEquals('executed_at', $this->container->getParameter('data_migrations.executed_at_column_name'));
        $this->assertFalse($this->container->getParameter('data_migrations.all_or_nothing'));
